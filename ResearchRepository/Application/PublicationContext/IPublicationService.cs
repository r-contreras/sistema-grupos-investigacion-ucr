...
namespace ResearchRepository.Application.PublicationContext
{
    public interface IPublicationService
    {
        ...
        /// <returns>Ammount of publications in total.</returns>
        Task<int> GetPublicationCountAsync(int id);

        Task<IList<Publication>> getPublicationByGroup(int id);

        /// <summary>
        /// Get the ammount of publications matching a search query.
        /// </summary>
        /// Author: David Sánchez López
        /// StoryID: ST-PH-1.3
        /// <param name="id">The ID of the publication.</param>
        /// <param name="term">The text query used to filter the content.</param>
        /// <returns>Ammount of publications regarding the search terms.</returns>
        Task<int> GetPublicationByTermCountAsync(int id, string term);

        /// <summary>
        /// Obtain a set of publications regarding a search query and a specific page.
        /// </summary>
        /// Author: David Sánchez López
        /// StoryID: ST-PH-1.3
        /// <param name="id">The ID of the publication.</param>
        /// <param name="currentPage">The current page being browsed.</param>
        /// <param name="size">Ammount of publications per page to be shown.</param>
        /// <param name="term">The text query used to filter the content.</param>
        /// <returns>Set of publications matching the current page and the search query.</returns>
        ...
        /// <param name="id">The ID of the publication.</param>
        /// <param name="term">The text query used to filter the content.</param>
        /// <returns>Ammount of publications regarding the search terms, including the summary.</returns>
        ...
        Task AddPublicationPartOfTesisAsync(PublicationPartOfTesis publicationPartOfTesis);
        /// <summary>
        ...
        Task AddProjectAsociatedAsync(ProjectAsociatedToPublication projectAsociatedToPublication);
        ...
        /// <summary>
        /// Get a list of all the references asociated to a publication.
        /// </summary>
        ...
        /// Author: Steven Nuñez
        /// StoryID: ST-HC-1.25
        /// <param name="publicationPartOfThesis">An object PublicationPartOfThesis</param>
        /// <returns> Task completed </returns>
        Task SavePublicationPartOfThesisAsync(PublicationPartOfTesis publicationPartOfThesis);
        ...
        /// <return> The list of the id's from the asociated publications.</return>
        Task<List<string>> GetPublicationsAsociatedToThesisAsync(int thesiId);
        ...
        Task addReference(string id, string reference, int order);
        ...
        /// <param name="order"> reference order </param>
        Task UpdateReference(string id, string reference, int order);
