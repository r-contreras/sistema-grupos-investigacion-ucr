...
namespace IntegrationTests.Infrastructure.WorkWithUs
{
    public class WorkWithUsFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<WorkWithUsDbContext>));
                ...
                services.AddDbContext<WorkWithUsDbContext>(
                    options =>
                    {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<WorkWithUsDbContext>();
                    var logger = scopedServices.GetRequiredService<ILogger<WorkWithUsFactory<TStartup>>>();
