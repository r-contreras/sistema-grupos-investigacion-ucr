...
namespace IntegrationTests.Infrastructure.Contacts
{
    public class ContactsFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var logger = scopedServices.GetRequiredService<ILogger<ContactsFactory<TStartup>>>();
