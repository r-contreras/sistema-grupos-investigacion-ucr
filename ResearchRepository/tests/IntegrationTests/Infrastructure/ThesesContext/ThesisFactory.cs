...
namespace IntegrationTests.Infrastructure.ThesesContext
{
    public class ThesisFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<ThesesDbContext>));
                ...
                services.AddDbContext<ThesesDbContext>(
                    options =>
                    {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<ThesesDbContext>();
                    var logger = scopedServices.GetRequiredService<ILogger<ThesisFactory<TStartup>>>();
