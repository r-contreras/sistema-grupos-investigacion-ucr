...
namespace IntegrationTests.Infrastructure.ResearchNews
{
    public class NewsFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var logger = scopedServices.GetRequiredService<ILogger<NewsFactory<TStartup>>>();
