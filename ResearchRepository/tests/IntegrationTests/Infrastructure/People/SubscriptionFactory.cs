...
namespace IntegrationTests.Infrastructure.People
{
    public class SubscriptionFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<SubscriptionsDbContext>));
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<SubscriptionsDbContext>();
                    var logger = scopedServices.GetRequiredService<ILogger<AcademicFactory<TStartup>>>();
