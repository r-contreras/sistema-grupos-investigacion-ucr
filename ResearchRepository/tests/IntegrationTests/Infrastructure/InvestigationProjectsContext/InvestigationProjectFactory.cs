...
namespace IntegrationTests.Infrastructure.InvestigationProjectsContext
{
    public class InvestigationProjectFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<InvestigationProjectsDbContext>));
                ...
                services.AddDbContext<InvestigationProjectsDbContext>(
                    options =>
                    {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<InvestigationProjectsDbContext>();
                    var logger = scopedServices.GetRequiredService<ILogger<InvestigationProjectFactory<TStartup>>>();
