...
namespace IntegrationTests.Infrastructure.StatisticContext
{
    public class StatisticFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<StatisticsDbContext>));
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<StatisticsDbContext>();
                    var logger = scopedServices.GetRequiredService<ILogger<StatisticFactory<TStartup>>>();
