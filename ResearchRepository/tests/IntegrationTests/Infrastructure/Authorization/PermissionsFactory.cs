...
{
    public class PermissionsFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<PermissionsContext>));
                ...
                services.AddDbContext<PermissionsContext>(
                    options =>
                    {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<PermissionsContext>();
                    var logger = scopedServices.GetRequiredService<ILogger<PermissionsFactory<TStartup>>>();
