...
{
    public class AccountIsAdministratorOfGroupTest
    {
        ...
        public void EmailEmptyReturEmpty()
        {
            ...
            //act
            var result = new AccountIsAdministratorOfGroup(input, GroupId);
        ...
        public void ConstructorGroupIdReturnsGroupId()
        {
            ...
            //act
            var result = new AccountIsAdministratorOfGroup(Email, GroupId);
